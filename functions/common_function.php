...
if(!isset($_GET['category'])){
     if(!isset($_GET['brand'])){
        ...
        while($row=mysqli_fetch_assoc($result_query)){
          ...
          <div class='card'>
            <img src='./Admin page/product_images/$product_image1' class='card-img' alt='$product_title'>
            <div class='card-body'>
...
if(isset($_GET['category'])){
     ...
     //  if no product in the category stock 
...
function search_product(){
  ...
  $num_of_rows=mysqli_num_rows($result_query);
        if($num_of_rows==0){
            echo "<h2 class='text-center text-danger'>No result match No category found on this category</h2>";
        }
           ...
           <div class='col-md-8'>
                    <!-- related images  -->
                      <div class='row'>
                        ...
                        <div class='col-md-6'>
                          <img src='./Admin page/product_images/$product_image2'  class='card-img'   alt='$product_title'>
                        </div>

                        <div class='col-md-6'>
                        <img src='./Admin page/product_images/$product_image3' class='card-img' alt='$product_title'>
                        </div>
      ...
      if(!isset($_GET['my_orders'])){
        if(!isset($_GET['delete_account'])){
          ...
          if($row_count > 0 && $row_count == 1){
            ...
            <p class = 'text-center'><a href='profile.php?my_orders' class ='text-dark btn btn-outline-primary'>Order Details</a></p>";
          }else{
            echo "<h3 class = 'text-center text-success mt-5 mb-2'>You have <span class='text-danger'>Zero</span> pending Orders</h3>
            <p class = 'text-center'><a href='../display_all.php' class ='text-dark btn btn-outline-primary'>Explore Products</a></p>";
          }
