...
if(isset($_POST['edit_cat'])){
    ...
    // index.php?category_title=Watches1&edit_cat=Update+Category
}
    ...
    <h1 class="text-center text-success">Edit Category</h1>
        <form action="" mehtod = "post" class="text-center">
            <div class="form-outline mb-4 w-50 m-auto">
                <label for="category_title" class="form-label"><h4>Category Title</h3></label>
                <input type="text" name="category_title" id="category_title" class="form-control" required="required" value='<?php echo $category_title; ?>'>
            </div>
            <input type="submit" value="Update_Category" class="btn btn-lg btn-outline-warning px-3 mb-3" name="edit_cat">
        </form>
