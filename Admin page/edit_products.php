...
<div class="container mt-5">
    ...
    while($row_brand_all=mysqli_fetch_assoc($result_brand_all)){
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <img src="./product_images/<?php echo $product_image1 ?>" alt="" class="product_img1">
            </div>
        </div>
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <img src="./product_images/<?php echo $product_image2 ?>" alt="" class="product_img1">
            </div>
        </div>
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <img src="./product_images/<?php echo $product_image3 ?>" alt="" class="product_img1">
            </div>
        </div>
        <div class="form-outline w-50 m-auto mb-4">
        ...
        <div class="text-center w-50 m-auto">
            <input type="submit" name="edit_product" value="Update Product" class="btn btn-lg btn-outline-primary px-3 mb-3">
        </div>
    </form>
</div>
